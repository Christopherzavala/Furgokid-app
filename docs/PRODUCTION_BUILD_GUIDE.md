...
BANNER_AD_UNIT_ID=ca-app-pub-REAL_PUBLISHER_ID/BANNER_ID
INTERSTITIAL_AD_UNIT_ID=ca-app-pub-REAL_PUBLISHER_ID/INTERSTITIAL_ID
REWARDED_AD_UNIT_ID=ca-app-pub-REAL_PUBLISHER_ID/REWARDED_ID
```
